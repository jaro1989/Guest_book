...
class Messanger extends pagination {
    /**
     * 
     * @param array $dataArray
     * Вывод сообщений
     */
    public static function renderMessages($dataArray) {
        foreach ($dataArray as $message) {
            // Show the information about the item
            echo '<p><b>' . $message['user'] . '</b><br /> &nbsp - &nbsp;' . $message['message'] . '</p>';
        }
    }
    /**
     * Вывод Select'а
    ...
    public function renderSelect() {
        $html .= "<form>";
        $html .= "<select name='mesNum' onchange='submit()'>";
        ($this->perPage == 5) ? $html .= "<option selected>5</option>" : $html .= "<option >5</option>";
        ($this->perPage == 10) ? $html .= "<option selected>10</option>" : $html .= "<option >10</option>";
        ($this->perPage == 15) ? $html .= "<option selected>15</option>" : $html .= "<option >15</option>";
        $html .= "</select>";
        $html .= "</form>";
        echo $html;
    }
